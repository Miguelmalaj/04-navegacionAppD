...
export const StackNavigator = () => {
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        headerStyle: { 
          elevation: 0,  /* Android: elimina la linea separadora entre el header y la pantalla */
          shadowColor: 'transparent' /* IOS: elimina la linea separadora entre el header y la pantalla */
        },
        cardStyle: { /* color de fondo de pantallas */
